// lib/rules/node/plugin/use-runtime-assertions.js
module.exports = {
  rules: {
          ...
          function findAssertionsRecursive(currentNode) {
            ...
            switch (currentNode.type) {
              ...
              case 'ForStatement':
                ...
                // test and update are expressions, less likely to be standalone assertions
              ...
              case 'WithStatement': // Generally discouraged
                findAssertionsRecursive(currentNode.body);
                break;
              // We generally don't need to recurse into expressions themselves
              // unless an assertion can be *part* of an expression, which is unusual.
              // The main check for ExpressionStatement > CallExpression covers assertion calls.
            }
          }
