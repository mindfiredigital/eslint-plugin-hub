// Helper function to convert a nested MemberExpression into a readable path string
          ...
          MemberExpression(node) {
            ...
            if (requireOptionalChainingOpt && chainDepth > 0) {
              ...
              for (let i = 0; i < links.length; i++) {
                ...
                // Only report if not already using optional chaining
                if (!linkNode.optional) {
                  ...
                  break; // Report only one missing optional chaining per chain
                }
              }
            }
          },
