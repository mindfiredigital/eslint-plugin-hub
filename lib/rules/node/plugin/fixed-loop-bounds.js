    ...
    create: function (context) {
      ...
      return {
        ...
        ForStatement(node) {
          ...
          // Note: Analyzing arbitrary `for` loop conditions (e.g., `for(let i=0; i < arr.length; i--)`) for termination
          // is complex and beyond the scope of this initial implementation.
          // This rule focuses on obvious `true` conditions or missing conditions.
        },
      };
    },
  },
